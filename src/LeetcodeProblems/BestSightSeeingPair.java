...
public class BestSightSeeingPair {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Output for values1: " + solution.maxScoreSightseeingPair(values1)); // Output: 11
        System.out.println("Output for values2: " + solution.maxScoreSightseeingPair(values2)); // Output: 2
    }
